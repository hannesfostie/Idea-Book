...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { city: @agency.city, country: @agency.country, email: @agency.email, name: @agency.name }
    end
  ...
  test "should update agency" do
    put :update, id: @agency, agency: { city: @agency.city, country: @agency.country, email: @agency.email, name: @agency.name }
    assert_redirected_to agency_path(assigns(:agency))
  end
